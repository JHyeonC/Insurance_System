...
import {MAPPING_POINT_PRODUCT_GET_ALL_PRODUCTS, MAPPING_POINT_PRODUCT_UNDERWRITE} from "../../../../common/MappingPoint/MappingPoint";
...
export default function Underwrite({employee}) {
    ...
    const handleSubmit = async (e) => {
        ...
        await axios.post(MAPPING_POINT_PRODUCT_UNDERWRITE, null, {
            params: {
