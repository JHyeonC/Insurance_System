...
import {
    ...
    MAPPING_POINT_BOARD_ANSWER, MAPPING_POINT_CLAIM_SUBMIT_REPORT, MAPPING_POINT_CLAIM_REVIEW_CLAIM
...
function ClaimRecord({claim, employee}) {
    function reviewClaim(result) {
        axios.post(MAPPING_POINT_CLAIM_REVIEW_CLAIM, null, {
            params: {
                id: claim.id,
                status: result
            }
...
export default function ReviewClaim({employee}) {
    ...
    function refreshClaims() {
        axios.get(MAPPING_POINT_CLAIM_GET_ALL_CLAIMS_BY_EMPLOYEE_ID, {
