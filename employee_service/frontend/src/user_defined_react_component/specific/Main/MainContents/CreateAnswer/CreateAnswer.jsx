...
import {MAPPING_POINT_BOARD_GET_ALL_BOARDS, MAPPING_POINT_BOARD_ANSWER} from "../../../../common/MappingPoint/MappingPoint";
    ...
    function answerBoard() {
        swal({
            ...
            if (answer === '') {
                ...
                axios.post(MAPPING_POINT_BOARD_ANSWER, null, {
                    params: {
                        id: board.id,
                        answer: answer,
...
export default function CreateAnswer({employee}) {
    ...
    function refreshBoards() {
        axios.get(MAPPING_POINT_BOARD_GET_ALL_BOARDS)
            .then(response => {
