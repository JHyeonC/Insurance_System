...
import {
    MAPPING_POINT_CLAIM_GET_ACCEPTED_CLAIMS,
    MAPPING_POINT_CLAIM_GET_ALL_CLAIMS_BY_EMPLOYEE_ID,
    MAPPING_POINT_BOARD_ANSWER, MAPPING_POINT_CLAIM_PAY_COMPENSATION, MAPPING_POINT_CLAIM_SUBMIT_REPORT
} from "../../../../common/MappingPoint/MappingPoint";
import swal from "sweetalert";
import Button from "../../../../common/Button/Button";

function ClaimRecord({claim, employee}) {
    function payCompensation() {
        axios.post(MAPPING_POINT_CLAIM_PAY_COMPENSATION, null, {
            params: {id: claim.id}
        })
            .then(response => {
...
export default function PayCompensation({employee}) {
    ...
    function refreshClaims() {
        axios.get(MAPPING_POINT_CLAIM_GET_ACCEPTED_CLAIMS)
            .then(response => {
